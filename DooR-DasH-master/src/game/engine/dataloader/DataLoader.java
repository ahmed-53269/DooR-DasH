		 ...
		 int c = 0;
		    for (int i = 0 ; i < cellsList.size() ; i ++){
		    	...
		    	if (csvRow.length == 3){
					...
					k++;
					//System.out.println("door cell iter no. " + k);
		    	}
		    	else{
		    		if (Integer.parseInt(csvRow[1].trim() ) > 0) {
		    			...
		    			loadedCells.add(cell);
						b++;
						//System.out.println("conBelt cell iter no. " + b);
						...
						loadedCells.add(cell);
						c++;
						//System.out.println("contamSock cell iter no. " + c);
...
public static void main(String [ ]args) throws IOException{
		 ...
		 ArrayList<Cell> cells = readCells();
